 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xFA, 0x09 /* 0x09FA - microjelly */
 ...
 */
#define USB_CFG_VENDOR_NAME     'm', 'i', 'c', 'r', 'o', 'j', 'e', 'l', 'l', 'y', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'B','E','E','O','N',' ','-',' ','C','L','A','S','S','I','C'
...
#define USB_CFG_SERIAL_NUMBER   'B','E','E','#','-','#','#','-','#','#','#','#','#','#','#'
#endif
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    128
